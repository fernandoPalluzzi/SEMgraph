...
**Supplementary Figure 1. SOD1-CASP3 path extraction and fitting.** The ACE in the example above is computed over the directed path (in gold) between SOD1 (source) and CASP3 (target).

![alt text](https://github.com/fernandoPalluzzi/SEMgraph/blob/master/docs/figures/Supplementary_Figure1.png)
