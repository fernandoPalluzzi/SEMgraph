...
- **KEGG pathways**. A comprehensive list of 306 KEGG pathways (last update: April 2020). [**\***]

- [**Reactome**](https://reactome.org) directed reference network of 9762 nodes and 416128 edges, derived from the **Reactome** database. [**\***]
