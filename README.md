...
- **KEGG pathways**. A comprehensive list of 306 KEGG pathways (last update: April 2020). [**\*[**SEMdata**](https://github.com/fernandoPalluzzi/SEMdata)**]

- [**Reactome**](https://reactome.org) directed reference network of 9762 nodes and 416128 edges, derived from the **Reactome** database. [**\*[**SEMdata**](https://github.com/fernandoPalluzzi/SEMdata)**]

- **Reactome pathways**. A comprehensive list of 1641 pathways (last update: April 2020). [**\*[**SEMdata**](https://github.com/fernandoPalluzzi/SEMdata)**]

- [**STRING**](https://string-db.org/) interactome (version 10.5) of 9725 nodes and 170987 edges. [**\*[**SEMdata**](https://github.com/fernandoPalluzzi/SEMdata)**]

- **Amyotrophic Lateral Sclerosis** (ALS) RNA-seq dataset of 139 cases and 21 healthy controls, from Tam O.H. *et al.*, 2019 (GEO accession: [**GSE124439**](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE124439)). [**\*[**SEMdata**](https://github.com/fernandoPalluzzi/SEMdata)**]

- **Frontotemporal Dementia** (FTD) DNA methylation dataset 150 cases and 150 healthy controls, from Li Y. *et al.*, 2014 (GEO accession: [**GSE53740**](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE53740)). [**\*[**SEMdata**](https://github.com/fernandoPalluzzi/SEMdata)**]
