...
**SEMgraph**  Estimate networks and causal relations in complex systems with **Structural Equation Modeling** using as input a **directed graph (adjacency matrix)** that encodes the hypothesized or data-driven causal relationships among variables. 
...
and "decomposed" subpathays (i.e., a list 8409 subgraphs with one input node and one output node)extracted from R package [**hipathia**](https://bioconductor.org/packages/hipathia/) (last update: October, 2024).
